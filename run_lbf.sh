...
python main.py --agent tiecomm --total_epoches 600 --env lbf --map Foraging-easy-v0 --block no --use_multiprocessing --memo aaai &
python main.py --agent tarmac --total_epoches 600 --env lbf --map Foraging-easy-v0 --block no --use_multiprocessing --memo aaai &
