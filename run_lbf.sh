...
python main.py --agent ac_mlp   --env lbf --map Foraging-easy-v0  --use_multiprocessing --memo env_test &
python main.py --agent gnn      --env lbf --map Foraging-easy-v0  --use_multiprocessing --memo env_test &
