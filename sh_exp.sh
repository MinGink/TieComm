...
python main.py --agent ac_mlp --env lbf --map Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 2 --epoch_size 2 --batch_size 200 &
python main.py --agent ac_att --env lbf --map Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 2 --epoch_size 2 --batch_size 200 &
python main.py --agent tiecomm_random --env lbf --map Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 2 --epoch_size 2 --batch_size 200 &
python main.py --agent tiecomm_one --env lbf --map Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 2 --epoch_size 2 --batch_size 200 &
