...
python main.py --agent tiecomm_one --env tj --map easy --use_multiprocessing --n_processes 4 -- epoch_size 5 --batch_size 200
...
python main.py --agent ac_mlp --env lbf --map lbforaging:Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 4 --epoch_size 5 --batch_size 200 &
python main.py --agent ac_att --env lbf --map lbforaging:Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 4 --epoch_size 5 --batch_size 200 &
python main.py --agent tiecomm_random --env lbf --map lbforaging:Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 4 --epoch_size 5 --batch_size 200 &
python main.py --agent tiecomm_one --env lbf --map lbforaging:Foraging-10x10-3p-3f-v2 --use_multiprocessing --n_processes 4 --epoch_size 5 --batch_size 200 &
